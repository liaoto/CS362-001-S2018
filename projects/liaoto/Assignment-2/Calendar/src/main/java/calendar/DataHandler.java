...
public class DataHandler {
    ...
    private static LinkedList<GregorianCalendar> getApptOccurences(Appt appt, 
        ...
        for (int i = -1; i < appt.getRecurNumber()+1; i++) { //BUG 5: i starts at 4 rather than 0  **This bug was changed from 4 to -1 because I could'nt find a way to get to be higher than 4
