...
public class CalDayTest{
  ...
  @Test 
  public void test03A() //test mutations
  {
	  GregorianCalendar today = new GregorianCalendar(1900,3,25);
	  CalDay Day = new CalDay(today);
	  ...
	  assertNotEquals(0, Day.getAppts().size());
	  
	  GregorianCalendar today2 = new GregorianCalendar(1900,3,25);
	  CalDay Day2 = new CalDay(today2);
	  assertEquals(0, Day2.getAppts().size());
  ...
  {
	  Appt appt0 = new Appt(26, 30, 9, 14, 2018, "Birthday Party", "This is my birthday party", "xyz@gmail.com");
	  Appt appt1 = new Appt(26, 30, 9, 14, 2018, "Hello Party", "This is my birthday party", "xyz@gmail.com");
	  Appt appt2 = new Appt(24, 30, 9, 14, 2018, "Removed Party", "This is my birthday party", "xyz@gmail.com");
	  Appt appt3 = new Appt(26, 30, 9, 14, 2018, "Thanksgiving Party", "This is my birthday party", "xyz@gmail.com");
	  GregorianCalendar today = new GregorianCalendar(1900,3,25);
	  CalDay Day = new CalDay(today);
	  Day.addAppt(appt0);
	  Day.addAppt(appt1);
	  ...
	  assertNotEquals(null, Day.getAppts());
	  
	  
	  assertEquals('T', Day.getAppts().get(3).getTitle().charAt(0)); 
  ...
  public void test07()  //tests tostring()
  {
	  ...
	  GregorianCalendar today = new GregorianCalendar(1900,5-1,27);
	  CalDay Day = new CalDay(today);
	  String fnVer = Day.toString();
	  assertNotEquals(-1, fnVer.indexOf('6'));
  ...
  public void test08()  //tests getFullInfomrationApp()   Tests PM AM Branch
  {
	  ...
	  CalDay Day2 = new CalDay(today2);
	  Appt appt2 = new Appt(12, 30, 9, 14, 2018, "Hello Party", "This is my birthday party", "xyz@gmail.com");
	  Day2.addAppt(appt2);
	  String fnVer2 = Day2.getFullInfomrationApp(Day2);
	  assertEquals('A', fnVer2.charAt(16));
  ...
  public void test09()  //tests getFullInfomrationApp()   Tests add 0 to minutes
  {
	  ...
	  Day.addAppt(appt1);
	  String fnVer = Day.getFullInfomrationApp(Day);
      assertEquals('0', fnVer.charAt(14));
	
	  
	  GregorianCalendar today2 = new GregorianCalendar(1922,3-1,25);
	  CalDay Day2 = new CalDay(today2);
	  Appt appt2 = new Appt(13, 10, 9, 14, 2218, "Hello Party", "This is my birthday party", "xyz@gmail.com");
	  Day2.addAppt(appt2);
	  String fnVer2 = Day2.getFullInfomrationApp(Day2);
	  assertEquals('0', fnVer2.charAt(15)); 
