...
public class ApptRandomTest {
   ...
   /**
	...
	//			System.out.println(" Seed:"+randomseed );
	  ...
	  @Test
	  public void randomTryForNullArray()  throws Throwable  {
	...
	//			System.out.println(" Seed:"+randomseed );
			...
			for (int i = 0; i < NUM_TESTS; i++) {
					...
					String methodName = ApptRandomTest.RandomSelectMethod(random);
					   if (methodName.equals("setTitle")){
						   ...
						   test_null = ValuesGenerator.getString(random);
						   if (test_null == null)
							  recurDays= null;
						   else
							  recurDays=ValuesGenerator.generateRandomArray(random, 2);
		 ...
		 System.out.println("Done testing...");
	 	 ...
	 	 @Test
	  public void randomSetValidtest()  throws Throwable  {
	...
	//			System.out.println(" Seed:"+randomseed );
				Random random = new Random(randomseed);
				 ...
				 int startYear=ValuesGenerator.getRandomIntBetween(random, -5, 20);
				 String title="Birthday Party";
				 String description="This is my birthday party.";
				 String emailAddress="xyz@gmail.com";
	  ...
	  @Test
	  public void randomisOn()  throws Throwable  {
	...
	//			System.out.println(" Seed:"+randomseed );
			 ...
			 if(!appt.getValid())continue;
			for (int i = 0; i < NUM_TESTS; i++) {
					int randoDay = ValuesGenerator.getRandomIntBetween(random, 1, 10);
					int randoMonth = ValuesGenerator.getRandomIntBetween(random, 1, 10);
					int randoYear = ValuesGenerator.getRandomIntBetween(random, 1, 10);
					appt.isOn(randoDay,randoMonth,randoYear);
				}
	  ...
	  @Test //test case for partner's bug
  public void test16 () throws Throwable
  {
	 
	 Appt appt1 = new Appt(1, 1, 1, 1, -2218, "Birthday Party", "This is my birthday party", "xyz@gmail.com");  
